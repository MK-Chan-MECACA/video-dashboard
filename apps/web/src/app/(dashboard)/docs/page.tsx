...
const ENDPOINTS: { method: string; path: string; scope: 'read' | 'write'; desc: string }[] = [
  ...
  { method: 'POST', path: '/videos/:id/actions', scope: 'write', desc: 'send_for_review · retry_failed · regenerate_voice · regenerate_scene (+scene_index) · regenerate_avatar · re_render · approve_script · request_script_changes (+comment) · approve_video · request_video_changes (+comment)' },
...
const TOOLS: { name: string; readOnly: boolean; desc: string }[] = [
  ...
  { name: 'video_action', readOnly: false, desc: 'send_for_review / retry_failed / regenerate_voice / regenerate_scene / regenerate_avatar / re_render' },
